package com.bearya.intelliscreen.library.tool;
...
public class StorageTool {
            ...
            if (volumeList != null) {
                for (Object o : volumeList) {
                    try {
                        ...
                        volume.setPath((String) o.getClass().getMethod("getPath").invoke(o));
                        volume.setRemovable((boolean) o.getClass().getMethod("isRemovable").invoke(o));
                        volume.setState((String) o.getClass().getMethod("getState").invoke(o));
    ...
    private static String usbDir = null;
        ...
        if (usbDir == null) {
            try {
                ...
                if (sdcardDir != null) {
                    ...
                    usbDir = sdcardDir + File.separator;
                }
            } catch (Exception e) {
